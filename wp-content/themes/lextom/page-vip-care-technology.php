...
<!-- HERO -->
<header class="lextom-hero lextom-hero--ecosystem lextom-hero--tall" style="background: url('<?php echo esc_url( $img . 'vipcare-logo.jpg' ); ?>') center/cover no-repeat; position: relative;">
  <!-- Dark overlay for text readability -->
  <div style="position: absolute; inset: 0; background: rgba(14, 34, 48, 0.75); z-index: 0;"></div>
